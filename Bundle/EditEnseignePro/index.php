<?php require('Bundle/EditEnseignePro/Controller/index.php'); ?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="red">
                                <h4 class="title">Modification des informations de votre enseigne</h4>
                            </div>
                            <div class="card-content">

                                <form method="post" action="./?page=editer_enseigne&id=<?=$toUp->id();?>" enctype="multipart/form-data" id="save">
                                    <!-- PARTIE 1 -->
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input value="<?=$toUp->nom();?>" type="text" class="form-control" id="nom" name="nom" placeholder="Nom de votre enseigne">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" id="description" name="description" placeholder="Description de votre enseigne"><?=$toUp->description();?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input value="<?=$toUp->url();?>" type="text" class="form-control" id="url" name="url" placeholder="exemple" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="alert alert-info text-left" role="alert">
                                            <i class="fa fa-info-circle" aria-hidden="true"></i> Nous travaillons actuellement sur la réécriture d'url, vous pourrez bientot accéder à votre enseigne depuis une url de type : http://eatzem.fr/exemple
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="livraison" id="livraison">
                                                <?=ModeLivraisonTool::buidSelectedSelect($toUp);?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input value="<?=$toUp->rayon_livraison();?>" type="number" class="form-control" name="rayon_livraison" id="rayon_livraison" placeholder="Rayon de livraison en kilomettres" />
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sur_place" id="sur_place">
                                                <option value="0" <?php if($toUp->sur_place() == 0){ echo 'selected';}?> selected>Non</option>
                                                <option value="1" <?php if($toUp->sur_place() == 1){ echo 'selected';}?>>Oui</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input value="<?=$toUp->adresse();?>" type="text" name="adresse" class="form-control" id="adresse" placeholder="Adresse" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input value="<?=$toUp->complement_adresse();?>" type="text" name="adresse_c" class="form-control" id="adresse_c" placeholder="Complément d'adresse" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input value="<?=$toUp->cp();?>" type="text" class="form-control" name="cp" id="cp" placeholder="Code postal" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="ville" id="ville">
                                                <option value="<?=$toUp->ville();?>" selected><?=$toUp->ville();?></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                ...
                                                <input value="<?=$toUp->telephone_fixe();?>" type="tel" class="form-control" name="telephone_fixe" id="telephone_fixe" placeholder="Téléphone (Ex : 0400000000" />
                                            </div>

                                            <!-- TELEPHONE PORTABLE -->
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                <label for="telephone_portable">Téléphone portable :</label>
                                                <input value="<?=$toUp->telephone_portable();?>" type="tel" class="form-control" name="telephone_portable" id="telephone_portable" placeholder="Téléphone (Ex : 0600000000" />
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <?php foreach($typList as $v){ ?>
                                                <label class="checkbox-inline space-bottom" for="<?=$v->id();?>">
                                                    <input type="checkbox" name="<?=$v->id();?>" id="<?=$v->id();?>"  <?php if(in_array($v->id(), $typArId)){ echo 'checked'; }?> />
                                                    <?=$v->type();?></label>
                                            <?php } ?>
                                        </div>
                                    </div>
