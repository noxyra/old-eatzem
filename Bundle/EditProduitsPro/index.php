<?php require('Bundle/EditProduitsPro/Controller/index.php'); ?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content table-responsive">
                                ...
                                <form method="post" action="./?page=editer_produit&prod_id=<?=$toUp->id();?>" enctype="multipart/form-data" id="save">
                                    <!-- NOM PRODUIT -->
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="appelation" name="appelation" placeholder="Nom de votre produit" value="<?=$toUp->appelation();?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select type="select" class="form-control" name="type" id="type">
                                                <?=TypeProduitTool::genoptionListSelected($toUp->type());?>
                                            </select>
                                        </div>
                                    </div>
...
<!--                                                <input type="checkbox" aria-label="...">-->
                                            ...
                                            <input type="text" id="durlim" name="duree_limite" class="pickdate form-control" placeholder="Date de fin, format : jj/mm/aaaa">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group text-right">
                    <span class="btn btn-success activator_ing" id="activator_ing_id"><span class="fa fa-plus" aria-hidden="true"> Ingrédients</span>
                                    </div>
                                    ...
                                    <div id="content_ing_picker" style="display: none">
                                        <fieldset>
                                            ...
                                            <p class="form_line_textarea">
                                                <?=IngredientsTool::genSelectedChoiceList($db, $toUp);?>
                                            </p>
                                        </fieldset>
                                    </div>
...
<script src="Bundle/EditProduitsPro/Ressources/JS/form.js"></script>
