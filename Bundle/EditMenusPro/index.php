<?php require('Bundle/EditMenusPro/Controller/index.php'); ?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content table-responsive">
                                ...
                                <form method="post" action="./?page=editer_menus&men_id=<?=$toUp->id();?>" id="save">
                                    <!-- PARTIE 1 -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" value="<?=$toUp->nom();?>"  name="nom" id="nom" placeholder="Nom du menu" />
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" id="description" name="description" placeholder="Décrivez votre menu [Cette case est optionnelle]"><?=$toUp->description();?></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="conditions" class="form-control" id="conditions" placeholder="Conditions pour ce menu [Cette case est optionnelle]"><?=$toUp->conditions();?></textarea>
                                    </div>
                                    <div class="alert alert-info text-left" role="alert">
                                        <i class="fa fa-info-circle" aria-hidden="true"></i>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" value="<?=$toUp->prix();?>" class="form-control" id="prix" name="prix" placeholder="prix" />
