<?php require('Bundle/EditEnseigneProduitsPro/Controller/index.php'); ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <p class="alert alert-info space-top">
                                    Pour chaque produit que vous souhaitez ajouter à votre enseigne, cliquez sur le bouton "selectionner".<br />
                                    Les produits sélectionnés apparaissent en rouge.
                                </p>
                            </div>

                            <form class="card-content table-responsive" method="post" action="./?page=editer_enseigne_produits&id=<?=$ens_id;?>">
                                    ...
                                    <table class="table">
                                        ...
                                        <?php foreach($ProEntList as $v){ ?>
                                            <tr class="line_table">
                                                <td><input type="checkbox" name="<?=$v->id();?>" id="<?=$v->id();?>" <?php if(in_array($v->id(), $ProArray)){ echo 'checked';}?> /><label for="<?=$v->id();?>">Sélectionner</label></td>
                                                <td><?=$v->appelation();?></td>
                                            </tr>
                                        <?php } ?>
                                    </table>
                                    ...
                                    <div class="form-group space-top text-right">
                                        <input type="submit" name="maj_produits_enseigne" class="btn btn-success" value="Sauvegarder" />
                                    </div>
                            </form>
                        </div>
                    </div>
...
<script src="Bundle/EditEnseigneProduitsPro/Ressources/JS/form.js"></script>
