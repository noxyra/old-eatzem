                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="red">
                                <h4 class="title">Historique de vos annonces</h4>
                            </div>
                            <div class="card-content">
                                <!-- TODO Redesigner quand il y aura des annonces -->

                                <div class="col-xs-12 panel-group">
                                    <?php foreach($listEnseigne as $enseigne){ ?>
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-collapse collapse in">
                                                <?php foreach($enseigne->annonces() as $annonce){ ?>
                                                    <div class="panel-body">
                                                        <h5><?=$annonce->distance_max();?> Km | <?=DateToolBox::conv_fr($annonce->date_ajout());?> - <?=$annonce->titre();?></h5>
                                                        <p>
                                                            <?=$annonce->contenu();?>
                                                        </p>
                                                    </div>
