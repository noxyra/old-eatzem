                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content table-responsive">
                                ...
                                <form method="post" action="./?page=enseigne_creator&selectAction=add_enseigne" enctype="multipart/form-data" id="save">
                                    <!-- PARTIE 1 -->
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" id="description" name="description" placeholder="Description de votre enseigne" id="description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="alert alert-warning text-left" role="alert">
                                            <p>
                                                ...
                                                Pour se faire il est important de choisir une image au format <strong>.png</strong> avec un <strong>fond transparent</strong> [ Nous travaillons actuellement sur un système de personnalisation de vos pages, il serait problématique que votre fond se retrouve inadapté (bien que vous puissiez le changer à tout moment). ]
                                            </p>
                                            <p class="text-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 space-top">
                                                <div class="alert alert-info text-left" role="alert">
                                                    ...
                                                    Vous pouvez ne mettre qu'un seul numéro de téléphone si vous le souhaitez.
                                                </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group text-right">
                                            <input class="btn btn-success" id="envoyer" type="submit" name="add_enseigne" value="Suivant">
                                        </div>
                                    </div>
                                </form>
                            </div>
